...
import type { TermsOfServiceBlock as TermsOfServiceBlockProps } from '@/payload-types'
import { motion } from 'framer-motion'
import RichText from '@/components/RichText'

export const TermsOfServiceBlock: React.FC<TermsOfServiceBlockProps> = ({
  title,
  richText,
  lastUpdated,
  contactEmail,
        ...
        >
          ...
          >
            <p className="text-sm text-gray-500">
              By using this website, you agree to these terms of service. Please review them
              carefully.
            </p>
          </motion.div>
        </motion.div>
